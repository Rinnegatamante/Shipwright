...
#ifdef __vita__
#include "gTitleRandomizerSubtitleTex.h"
#endif
...
void DrawTitleRandomizerSubtitleTex(GraphicsContext* gfxCtx, s16 centerX, s16 centerY, u32 width, u32 height) {
    u8* curTexture;
    s32 textureCount;
    u32 rectLeft;
    u32 rectTop;
    ...
    curTexture = gTitleRandomizerSubtitleTex;
